...
fun HomeScreen(onLogoutClick: () -> Unit) {
    val productList = listOf(
        ...
        Product("Baskets décontractée", "WARRIOR Baskets décontractées à semelle épaisse", painterResource(id = R.drawable.product_image_3)),
        Product("Robe de demoiselle", " Robe de demoiselle élégante en noir et blanc", painterResource(id = R.drawable.product_image_4)),
        Product("Sweatshir", " Attitoon Sweatshirt imprimé 'NEW YORK BROOKLYN ", painterResource(id = R.drawable.product_image_5)),
